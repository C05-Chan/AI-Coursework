# ========================================================================================== #
#                                                                                            #
# This code is to plot one frame with angles, not related to GA, but it allows you to        #
# visualise the Neural Network output                                                        #
#                                                                                            #
# ========================================================================================== #
...
def main():
    angles_frame = []
    angles = [0.14475136, 0.28525023, 0.21096817, 0.15370002, 0.1714549,  0.18900333,
 ...
 0.20022314, 0.17763588, 0.19096775, 0.22437265, 0.19513602, 0.16566045] 
    ...
    angles_frame.append(list(angles))
